  ...
  return (
    <div>
      <section>
        ...
        <address>
          by Kate Farley (<a href="mailto:kate.farley@nytimes.com"> kate.farley@nytimes.com</a>)
        </address>
        ...
        <p>
          Made of copper and gold so that it would shine bright, the first torch took a beating from the weather and was replaced by a replica in  <time datetime="1984">1984</time>. It's been stored in the statue's pedestal ever since.
        </p>
        <p>
          But visitors will be able to see the original 3,600-pound torch in all its glory at a new Statue of Liberty Museum, which will open on Liberty Island in <time datetime="2019-05">May 2019</time>. The torch was transported there by truck last week, along with a replica model of Lady Liberty's face.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Lady Liberty was a gift from France to the United States to celebrate the centennial of their nation's independence -- although, somewhat awkwardly, she arrived a decade too late. Nevertheless, President Grover Cleveland formally unveiled her in <time datetime="1886">1886</time>.
        </p>
        <p>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            Height of the Statue from her heel to the top of her head is <b>111 feet, 6 inches</b>
          </li>
          <li>
